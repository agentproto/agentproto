...
requires: [1, 2, 54]
ref-impl: https://github.com/agentproto/ts/tree/main/packages/governance/core
discussions-to: https://github.com/agentproto/agentproto/discussions/7
layer: coordination
package: "@agentproto/governance"
---
...
| Reference Impl | [`packages/governance/core`](https://github.com/agentproto/ts/tree/main/packages/governance/core) |
...
> [`packages/governance/core/AGENTGOVERNANCE.md`](https://github.com/agentproto/ts/blob/main/packages/governance/core/AGENTGOVERNANCE.md).
...
under [AIP-54 REF](/docs/aip-54). The fields use AIP-54's
collection-typed form so consumers get extension-friendly constraints:

| Doctype field | AIP-54 collection | Example values |
|---|---|---|
...
AIP-54 details, this drift is the principal blocker to harmonizing
across the agentproto registry. AIP-7 imports AIP-54 to:

1. **Replace `kind:slug` regex parsing** with the canonical AIP-54
...
forms remain valid wire formats and are preprocessed into AIP-54 `Ref`
values at parse time. Validators normalize on read. Producers SHOULD
emit AIP-54 object form on write; consumers MUST accept either.

A future AIP-7 v2 will deprecate the legacy string forms and require
AIP-54 object form on write. The reference implementation tracks this
...
[`packages/governance/core`](https://github.com/agentproto/ts/tree/main/packages/governance/core) —
...
the roadmap: the AIP-54 Ref migration described above. Within this
draft, both the legacy `kind:slug` string form and the AIP-54 object
