...
requires: [1, 2]
ref-impl: https://github.com/agentik/agentik-studio/tree/dev/packages/agent-framework/src/wiki
discussions-to: https://github.com/agentproto/specs/discussions/10
---
...
| Reference Impl | [`packages/agent-framework/src/wiki`](https://github.com/agentik/agentik-studio/tree/dev/packages/agent-framework/src/wiki) |
...
and the same authoring skill ([`./resources/aip-10/draft/skills/author-knowledge/SKILL.md`](https://github.com/agentik/agentik-studio/blob/dev/apps/agentik/sites/content/docs/agentproto/resources/aip-10/draft/skills/author-knowledge/SKILL.md))
...
[`packages/agent-framework/src/wiki`](https://github.com/agentik/agentik-studio/tree/dev/packages/agent-framework/src/wiki) —
