...
ref-impl: https://github.com/agentproto/ts/tree/main/packages/runner
---
...
A consumer (e.g. CODE.md, DRIVER.md) MAY use any of the three.
...
- [AIP-23 — IDENTITY.md](/docs/aip-23) — sibling block (identity-ref)
- [AIP-26 — CODE.md](/docs/aip-26) — sibling block (bundle composition)
- [AIP-30 — DRIVER.md](/docs/aip-30) — primary consumer (binding)
- [AIP-37 — LIFECYCLE.md](/docs/aip-37) — event vocabulary referenced by lifecycle hooks
