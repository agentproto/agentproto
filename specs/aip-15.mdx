...
body lives on the AIP-30 DRIVER that implements the TOOL contract,
and driver resolution happens at step-execution time per AIP-30's
resolver.
...
- id: fetch-page
  ...
  # Optional per-step driver pin (escape hatch — usually omit):
