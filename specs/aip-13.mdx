...
> hardcoded `project`, `initiative`, and `task` doctypes. It has been
> superseded by [AIP-20](/docs/aip-20) (`agentwork/v2`), which lifts
> the per-item-kind schemas to [AIP-18](/docs/aip-18) collections.
> AIP-20 itself is still Draft; its `agentwork-v1-compat` starter
> collections keep existing v1 workspaces loadable during the
> transition.
