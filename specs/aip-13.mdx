...
requires: [1, 2, 6, 7, 9]
ref-impl: https://github.com/agentik/agentik-studio/tree/dev/packages/agent-framework/src/work
discussions-to: https://github.com/agentproto/specs/discussions/13
---
...
| Reference Impl | [`packages/agent-framework/src/work`](https://github.com/agentik/agentik-studio/tree/dev/packages/agent-framework/src/work) |
...
([`./resources/aip-13/draft/skills/author-work-workspace/SKILL.md`](https://github.com/agentik/agentik-studio/blob/dev/apps/agentik/sites/content/docs/agentproto/resources/aip-13/draft/skills/author-work-workspace/SKILL.md))
...
[`packages/agent-framework/src/work`](https://github.com/agentik/agentik-studio/tree/dev/packages/agent-framework/src/work) —
