...
layer: primitives
package: "@agentproto/sandbox"
ref-impl: https://github.com/agentproto/ts/tree/main/packages/sandbox
---
...
| Type | Schema |
| Domain | sandbox.sh |
| Requires | [AIP-17](/docs/aip-17) (RUNNER), [AIP-19](/docs/aip-19) (SECRETS), [AIP-35](/docs/aip-35) (STORAGE) |
...
| `policy` | object \| array | (none) | AIP-38 POLICY block — access grants on sandbox actions (`sandbox:execute`, `sandbox:network-egress`, etc.). Inline / ref / file. See [AIP-38 POLICY.md](/docs/aip-38). |
