...
import { runTool } from "@agentproto/provider"
import { defineSdkProvider, resolveFunctionRef } from "../index.js"
...
describe("defineSdkProvider — end-to-end via runTool", () => {
  it("dispatches to a custom-loaded module's default export with object args", async () => {
    ...
    const provider = defineSdkProvider({
